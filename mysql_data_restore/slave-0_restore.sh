#!/bin/bash
# slave-0_restore.sh - 触发 test-mysql-slave-0 的数据还原

NAMESPACE="test"
SLAVE_POD="test-mysql-slave-0"
STS_NAME="test-mysql-slave"
DATA_DIR="/opt/app/test-mysql/slave-0/data"
...
echo ""
echo "前置条件检查清单："
echo "  1. 已从 master-0 执行最新备份 (bash mysql_data_backup/master-0_backup.sh)"
